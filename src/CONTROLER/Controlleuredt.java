...
public class Controlleuredt {
    ...
    public void msg() {
        ...
        liste = courrr.affichageclasse(1, semaine, listesalle, listeutilisateur, listeseance, listegroupe, listeprof, listecours, listeetudiant, listessalles, listesite, groupetab);

    }

    public void lanceetudiant() {
        
        new Edtetudiant(liste, semaine);
    }
